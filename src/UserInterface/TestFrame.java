...
public class TestFrame extends JFrame{
	...
	public void createFrame() {
		...
		print.setToolTipText("Сохранить в файл");
...
//				MainRender.setTo(dcmImg.getTo());
	...
	private void saveToFileActions()
	{
		JFileChooser fileChooser = new JFileChooser();
		FileNameExtensionFilter filter = new FileNameExtensionFilter("png", "png");
		fileChooser.setFileFilter(filter);
		if (fileChooser.showSaveDialog(TestFrame.this) == JFileChooser.APPROVE_OPTION) 
		{
		  File file = fileChooser.getSelectedFile();
		  if(file != null)
		  {
			  RenderingLoop.saveScreenToFile(file);
		  }
		}
	}
